...
static const NSTimeInterval CSToastFadeDuration = 0.7;

// space from bottam
static const CGFloat CSToastSpaceFromBottam     = 50.0;
...
- (CGPoint)centerPointForPosition:(id)point withToast:(UIView *)toast {
    ...
    // default to bottom
    return CGPointMake(self.bounds.size.width/2, (self.bounds.size.height - (toast.frame.size.height / 2)) - CSToastVerticalPadding - CSToastSpaceFromBottam);
}
