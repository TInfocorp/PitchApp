...
- (void)viewDidLoad
{
    ...
    if (self){
        ...
        UIView *vwTopSt=[[UIView alloc] init];
        vwTopSt.autoresizingMask = UIViewAutoresizingFlexibleWidth;
        vwTopSt.frame=CGRectMake(0, 0, vwTopSt.frame.size.width, 65);
        
        [contentView addSubview:vwTopSt];
        vwTopSt.backgroundColor =[UIColor colorWithRed:0/255.0 green:64/255.0 blue:86/255.0 alpha:1];
        [contentView bringSubviewToFront:vwTopSt];
        contentView.backgroundColor = [UIColor blackColor];
        UIButton *btnCancel=[[UIButton alloc]initWithFrame:CGRectMake(0, 15, 80, 40)];
        

        UIButton *btnDone=[[UIButton alloc]initWithFrame:CGRectMake(self.view.frame.size.width-80, 15, 80, 40)];
        ...
        [vwTopSt addSubview:btnCancel];
        [vwTopSt addSubview:btnDone];
...
//                                                  action:@selector(done:)];
        ...
        CGRect view = CGRectMake(0,65, self.view.bounds.size.width, self.view.bounds.size.height - [[self navigationController] navigationBar].bounds.size.height - statusBarSize.height);
