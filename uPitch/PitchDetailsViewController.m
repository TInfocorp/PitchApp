...
//                      }
         ...
         {
             [appdelegateInstance hideHUD];
             UIAlertView*alert12=[[UIAlertView alloc]initWithTitle:nil message:@"Connectivity levels low. Please try again." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil];
            [alert12 show];
