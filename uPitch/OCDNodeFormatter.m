...
{    
    ...
    switch (self.formatterType) {
        case OCDNodeFormatterTypeArc: {
            ...
            [node setValue:[NSString stringWithFormat:@"0,0,%@,%@",[[NSUserDefaults standardUserDefaults]objectForKey:@"outerRadius"],[[NSUserDefaults standardUserDefaults]objectForKey:@"outerRadius"]] forAttributePath:@"bounds"];
           // [node setValue:@"0,0,100,100" forAttributePath:@"bounds"];
